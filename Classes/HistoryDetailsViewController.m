...
+ (void)adaptSize:(UILabel *)label field:(UIView *)field {
    ...
    CGRect frame = [[label text] boundingRectWithSize:contraints options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading) attributes:@{NSFontAttributeName:[label font]} context:nil];
