...
/**
 ...
 Only triggered when using RgTextViewController's text view.
 */
...
/** A single tap gesture used to dismiss the keyboard. RgTextViewController is its delegate. */
@property (nonatomic, readonly) UIGestureRecognizer *singleTapGesture;

/** A vertical pan gesture used for bringing the keyboard from the bottom. RgTextViewController is its delegate. */
