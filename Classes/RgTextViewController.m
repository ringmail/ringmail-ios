...
#define kSLKAlertViewClearTextTag [NSStringFromClass([RgTextViewController class]) hash]
...
@interface RgTextViewController ()
{
...
- (void)textDidUpdate:(BOOL)animated
{
    ...
    if (inputbarHeight != self.textInputbarHC.constant)
    {
        ...
        if (animated) {
            ...
            __weak RgTextViewController* weakSelf = self;
